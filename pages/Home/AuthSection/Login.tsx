        ...
        <div className="SessionWrapper">
            ...
            {props.userData.session.key && props.userData.session.expires > Date.now() ? <>
                <p className="Timer" style={{
                    color: Math.floor(sessionCounter/1000) > (props.sessionCounterAmount*60) / 2 ? 'var(--green)' : Math.floor(sessionCounter/1000) > (props.sessionCounterAmount*60) / 4 ? 'var(--yellow)' : 'var(--lightRed)',
                }}>

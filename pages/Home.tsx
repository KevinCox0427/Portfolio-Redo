        ...
        <main>
            ...
            <div id="WhatICanDo" className='Contain'>
                <div className='NavBar'>
                    <h2>I can</h2>
                    <a>create optimized databases</a>
                    <a>authenticate users</a>
                    <a>integrate applications</a>
                    <a>create UIs to control it all</a>
                    <a>and beautiful websites to show it all</a>
                </div>
            </div>
        </main>
        <Footer></Footer>

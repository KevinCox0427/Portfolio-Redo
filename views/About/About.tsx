                    ...
                    <div className="Resume">
                        <div className="Column">
                            <div className="Section Description">
                                ...
                                <p>An ideas-driven developer and designer that uses a diverse skill set to supply any technical or graphical need. An advocate for requiring a fundamental understanding of project ideas, web technologies, and visual design to provide a wide array of user-oriented solutions. An  independent, highly motivated worker that specializes in scaling the visual identity and technical stacks of small to medium sized businesses, but is comfortable in large production environments.</p>
                            </div>

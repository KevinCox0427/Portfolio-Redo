                    ...
                    <div className="Resume">
                        <div className="Column">
                            <div className="Section Description">
                                ...
                                <p>An ideas-driven designer and developer that uses a diverse skill set to supply any graphical or technical need. An advocate for requiring a fundamental understanding of visual design, project ideas, and web technologies to provide a wide array of user-oriented solutions. An independent, highly motivated worker that specializes in the scaling of a business’s visual identity, graphics, web applications, and technical stacks to align with their goals.</p>
                            </div>
                            ...
                            <div className="Section Experience">
                                ...
                                <div className="Job">
                                    ...
                                    <ul>
                                        <li>Designed, developed, and managed a team of 5 to serve and maintain 7 on-going clients.</li>
                            ...
                            <div className="Section Skills">
                                ...
                                <div className="SkillsWrapper">
                                    <div className="Skill">
                                        ...
                                        <p> TypeScript, React.JS, Angular.JS, Webpack, SASS, JQuery, HTML, CSS, JavaScript, Unit Testing, Jest.JS</p>
                                    </div>
                                    <div className="Skill">
                                        <h4>Back-end Development</h4>
                                        <p>Python, Node.js, PHP, Docker, AWS, Flask, Express.js, WordPress, Server-side Rendering, User Session Management</p>
                                    </div>
                                    <div className="Skill">
                                    ...
                                    <div className="Skill">
                                        ...
                                        <p>Great communication skills, Converts ideas into technical projects, Great client engagement with mock-ups and demos, Gives accurate estimates.</p>
                                    </div>
                                </div>
                            </div>
                        </div>

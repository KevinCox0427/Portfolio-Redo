...
const AuthSection:FunctionComponent<Props> = (props) => {
    ...
    return <div id="authentication" className="Section"  style={{
        ...
        <div className='Example'>
            ...
            <Login userData={userData} setUserData={setUserData} sessionCounterAmount={sessionCounterAmount} createSession={createSession} cachedHasLoaded={props.cachedHadLoaded}></Login>
        </div>
    </div>
}
